    ...
    return (
        <div>
            <div className='flex justify-around mt-20 items-center relative'>
                <div>
                    <h1 className='text-5xl font-semibold w-[30rem] leading-snug'>Your <span className='text-blue-500'>trusted partner</span> in digital healthcare </h1>
                    ...
                    <div>
                        <button className='bg-primary w-52 h-10 bg-blue-400 rounded-md text-white mt-5'>Book an appointment </button>
                    </div>
                    <div>
