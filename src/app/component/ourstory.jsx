    ...
    return (
        <div className='flex justify-center items-center'>
            <div className='border border-blue-400 rounded-md mt-40 w-[65rem] h-[30rem] shadow-xl'>
                <h1 className='text-3xl font-semibold text-center pt-5 '><span className='text-transparent bg-gradient-to-r from-blue-300 to-blue-700  bg-clip-text'>HealNet's Story:</span> Get to know  us</h1>
                ...
                <div className='flex items-center justify-around pt-10'>
                    ...
                    <div>
                        ...
                        <button className='bg-gradient-to-l from-blue-500 to-blue-200  text-white w-48 h-14  rounded-md mt-10'>Learn more about us</button>
                    </div>
                </div>
            </div>
        </div>
